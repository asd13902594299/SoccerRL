...
class Scenario(BaseScenario):
    def make_world(self, num_good=1, num_adversaries=1, num_obstacles=0):
        world = World()
        ...
        for i, agent in enumerate(world.agents):
            ...
            base_name = "blue" if agent.adversary else "red"
        ...
        world.ball.size = 0.1  # Smaller than agents
