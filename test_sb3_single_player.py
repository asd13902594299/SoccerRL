...
class LoggingCallback(BaseCallback):
    def __init__(self, verbose=0):
        ...
        self.csv_file = open('test_sb3_single_player_logs.csv', 'w', newline='')
    ...
    def _on_step(self) -> bool:
        # Need this as an abstract method needed to avoid errors
...
def train():
    ...
    model = PPO("MlpPolicy", env, verbose=1, device=device, learning_rate=0.0001, ent_coef=0.01, gamma=0.97, batch_size=32)
